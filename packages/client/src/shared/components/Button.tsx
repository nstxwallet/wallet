...
export const Button = ({
	...
	const variantStyles = {
		primary: "bg-blue-500 border border-blue-500 text-white hover:bg-blue-600 focus:ring-blue-300",
		secondary: "bg-amber-400 border border-amber-600 text-white hover:bg-amber-600 focus:ring-amber-500",
		transparent: "bg-transparent border border-gray-700 hover:bg-gray-900 focus:ring-blue-300",
		danger: "bg-none border-red-500 text-white hover:bg-red-400 focus:ring-red-300",
